...
class NegationSaveT(nn.Module):
    ...
    def forward(self,
        ...
        # torch.save(feats_templates[:7, :], 
        #                     "cache/aft_pos_template.pt")
        # torch.save(feats_templates[7:, :], 
        #                     "cache/aft_neg_template.pt")
        ...
        torch.save(feats_templates[:7, :], 
                            "savet/aft_pos_template.pt")
        torch.save(feats_templates[7:, :], 
                            "savet/aft_neg_template.pt")
